...
import {
  ...
  PoDynamicFormField,
  PoDynamicModule,
  PoInfoModule, PoListViewAction, PoListViewModule
...
export class UpdateCustomerComponent implements OnInit {
  ...
  fieldsCustomer: Array<PoDynamicFormField> = [];
  ...
  getCustomer() {
    this.service.getById(this.activatedRoute.snapshot.params['id']).subscribe(response => {
      this.customer = response;
      this.addresses = this.customer.addresses;

      this.phones = this.customer.phones.map(item => {
