...
public class RulesUpdateCustomerImpl implements RulesUpdateCustomer {
    ...
    public void validate(Customer customer) {
        ...
        if (customerRepository.nameAlreadyRegistered(customer.getName(), customer.getId())) {
        ...
        if (customerRepository.cpfAlreadyRegistered(customer.getCpf(), customer.getId())) {
        ...
        for (String phone : customer.getPhones()) {
            ...
            } else if (customerRepository.phoneAlreadyRegistered(phone, customer.getId())) {
